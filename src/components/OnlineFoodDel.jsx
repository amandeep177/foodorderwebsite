...
const OnlineFoodDel = ({data,title}) => {
  ...
  const filterOptions = ["Ratings 4.0+","Offers","Rs. 300-Rs.600","Less than 400",  ]
        ...
        <div className='my-7 flex gap-6 '>
          {
            filterOptions.map(filterName=>(
              ...
              <button onClick={()=> handleFilterBtn(filterName)} className={'filterbtn flex gap-1 ' + (activeBtn===filterName ? "active" : "")} >
                <p>  {filterName}   </p>

...
const Body = () => {
  ...
  const filteredData = TopRestaurantdata.filter((item) => {
    ...
    switch (filterVal) {
      ...
      case "Less than 400":
        return item?.info?.costForTwo.split(" ")[0].slice(1) < "400";
      default:
        return true;
    }
  });
  ...
  if (unservicedata.communication) {
    return (
      <div className="flex flex-col items-center justify-center h-auto  text-center p-6 mt-44">
        <div className="mb-6">
          <img
            src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_490,h_476/portal/m/location_unserviceable.png"
